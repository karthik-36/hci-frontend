...
export default class About extends Component {
    render() {
        return (
            <div>
               Design Challenge 1: Adding new food donations and specifying details
...
Design Challenge 2: Tracking food donated and received
...
Design Challenge 4: Communication between Donor and Receiver
